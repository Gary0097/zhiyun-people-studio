...
APP_CONTEXT = (
    "你是「制造云 AI-OS」{title}的智能助手。你可以调用 review_permission_suggestions、review_contact_search、review_approval_path、review_anniversaries、review_hr_analytics 等工具，"
...
class AgentChatRequest(BaseModel):
    ...
    app_id: str | None = Field(default="zhiyun-people-studio", description="Owning app id")
